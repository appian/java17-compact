 ...
 * Brief description of changes: Repackaged from sun.util.calendar to com.appiancorp.jre17.compact.thirdparty.sun.util.calendar; adjusted tzdb.dat loading to read it as a classpath resource bundled next to this class instead of the JDK's own module/resource layout.
 *
 * This code is free software; you can redistribute it and/or modify it
...
public final class ZoneInfoFile {
    ...
    static {
        ...
        AccessController.doPrivileged(new PrivilegedAction<Void>() {
            public Void run() {
                try {
                    // Modified by Appian Corp., 2026: load tzdb.dat as a classpath
                    // resource bundled next to this class (generated by the
                    // generateTzdbDat Gradle task) instead of from
                    // ${java.home}/lib/tzdb.dat via jdk.internal.util.StaticProperty,
                    // which is not accessible outside java.base.
                    try (DataInputStream dis = new DataInputStream(
                             new BufferedInputStream(
                                 ZoneInfoFile.class.getResourceAsStream("tzdb.dat")))) {
                        load(dis);
                    }
                } catch (Exception x) {
                    throw new Error(x);
