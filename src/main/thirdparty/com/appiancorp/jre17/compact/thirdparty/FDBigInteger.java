 ...
 * Brief description of changes: Repackaged from jdk.internal.math to com.appiancorp.jre17.compact.thirdparty; replaced the JDK-internal jdk.internal.misc.CDS-backed static initializer (module-private, inaccessible outside the JDK) with a plain static initializer computing identical cache values.
 *
 * This code is free software; you can redistribute it and/or modify it
