 ...
 * Brief description of changes: Repackaged from sun.util.resources to com.appiancorp.jre17.compact.thirdparty.sun.util.resources; replaced use of the JDK-internal jdk.internal.access.SharedSecrets/JavaUtilResourceBundleAccess bridge (unreachable outside java.util without --add-opens) with the new AppianResourceBundleState interface.
 *
 * This code is free software; you can redistribute it and/or modify it
